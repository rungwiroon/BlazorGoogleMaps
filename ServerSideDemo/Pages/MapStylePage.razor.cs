...
namespace ServerSideDemo.Pages
{
    public partial class MapStylePage
    {
        ...
        public MapTypeStyle[] MapStyle()
        {
            ...
            // return new GoogleMapStyleBuilder()
            //     .AddHue(MapStyleFeatures.All, null, "#e7ecf0")
            //     .AddSaturation(MapStyleFeatures.All, null, 0)
            //     .AddSaturation(MapStyleFeatures.Road, null, -70)
            //     .AddVisibility(MapStyleFeatures.Transit, null, MapStyleVisbility.Off)
            //     .AddVisibility(MapStyleFeatures.Poi, null, MapStyleVisbility.Off)
            //     .AddVisibility(MapStyleFeatures.Water, null, MapStyleVisbility.Simplified)
            //     .AddSaturation(MapStyleFeatures.Water, null, -60)
            //     .Build();
