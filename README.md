...
```
Add path to project js file in filewwwroot/index.html in Client side or _Host.cshtml in Server Side. Right after < script src="_framework/blazor.server.js"></ script >
```
